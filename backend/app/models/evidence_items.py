...
class EvidenceItem(Base):
    ...
    # กันอัปโหลดซ้ำ: หน้าเว็บสร้าง UUID ต่อไฟล์ตั้งแต่ตอนเลือกไฟล์ แล้วส่งมาทุกครั้ง
    # ถ้าค่านี้เคยบันทึกสำเร็จแล้ว ระบบคืนผลเดิมกลับไปโดยไม่ยิงธุรกรรมใหม่ขึ้นเชน
